...
public class ClienteRest {
	...
	@GET
	@Operation(summary = "Listar clientes", description = "Lista de clientes com nome, cpf, endereco, email, e contato")
	...
	public Response listar() {
		return Response.status(Response.Status.OK).entity(clienteService.listar()).build();
	}
	...
	@APIResponse(responseCode = "202", description = "cliente", content = {
			@Content(mediaType = "application/json", schema = @Schema(implementation = ClienteDto.class)) })
